...
import br.gov.ba.pm.sgeapm.domain.Perfil;
import br.gov.ba.pm.sgeapm.domain.PerfilTipo;
import br.gov.ba.pm.sgeapm.domain.Usuario;
import br.gov.ba.pm.sgeapm.exception.AcessoNegadoException;
import br.gov.ba.pm.sgeapm.repository.UsuarioRepository;
...
public class UsuarioService implements UserDetailsService {
	...
	public void salvarCadastroPaciente(Usuario usuario) throws MessagingException {
		String crypt = new BCryptPasswordEncoder().encode(usuario.getSenha());
		usuario.setSenha(crypt);
		usuario.addPerfil(PerfilTipo.ALUNO);
		repository.save(usuario);	
